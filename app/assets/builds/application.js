(() => {
  ...
  var Subscriptions2 = class {
    ...
    create(channelName, mixin) {
      ...
      const subscription2 = new Subscription2(this.consumer, params, mixin);
      return this.add(subscription2);
    }
    add(subscription2) {
      this.subscriptions.push(subscription2);
  ...
  // app/javascript/channels/group_chat_channel.js
  ...
  document.addEventListener("turbo:load", () => {
    ...
    if (form) {
      ...
      subscription = consumer_default.subscriptions.create({ channel: "GroupChatChannel", group_id: groupId }, {
        connected() {
